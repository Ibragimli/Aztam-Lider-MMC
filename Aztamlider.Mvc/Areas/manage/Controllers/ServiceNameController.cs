    ...
    public class ServiceNameController : Controller
    {
        ...
        public async Task<IActionResult> Create(ServiceNameCreateDto ServiceNameCreateDto)
        {
            ...
            try
            {
                ...
                await _loggerServices.LoggerCreate("ServiceName", "Create", user.FullName, user.RoleName, ServiceNameCreateDto.NameAz);
            }
        ...
        public async Task<IActionResult> Edit(ServiceName ServiceName)
        {
            ...
            try
            {
                ...
                if (user == null)
                    throw new UserNotFoundException("Error bas verdi!");
                await _loggerServices.LoggerCreate("ServiceName", "Edit", user.FullName, user.RoleName, product.NameAz);
            }
        ...
        public async Task<IActionResult> Delete(int id)
        {
            try
            {
                ...
                if (user == null)
                    throw new UserNotFoundException("Error bas verdi!");
                await _loggerServices.LoggerCreate("ServiceName", "Delete", user.FullName, user.RoleName, product.NameAz);
            }
            catch (ItemNotFoundException ex)
            {
