...
{
    public class ServiceNameCreateDto
    {
        public string NameAz { get; set; }
        public string NameEn { get; set; }

    }
    public class ServiceNameCreateDtoValidator : AbstractValidator<ServiceNameCreateDto>
    {
        public ServiceNameCreateDtoValidator()
        {
