...
namespace Aztamlider.Services.Dtos.User
{
    ...
    public class ContactUsCreateDtoValidator : AbstractValidator<ContactUsCreateDto>
    {
        public ContactUsCreateDtoValidator()
        {
            ...
            RuleFor(x => x.Message).NotEmpty().WithMessage("Mesajınızı qeyd edin.").MinimumLength(3).WithMessage("Mesajınızın uzunluğu 3-dən az ola bilməz!").MaximumLength(5000).WithMessage("Mesajınızın uzunluğu 5000-dən böyük ola bilməz!");
        }
    }
}
