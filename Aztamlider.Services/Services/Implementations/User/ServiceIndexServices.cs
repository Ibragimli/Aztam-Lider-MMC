...
{
    public class ServiceIndexServices : IServiceIndexServices
    {
        private readonly IUnitOfWork _unitOfWork;

        public ServiceIndexServices(IUnitOfWork unitOfWork)
        {
        ...
        public async Task<IEnumerable<ServiceImage>> GetServiceImages()
        {
            return await _unitOfWork.ServiceImageRepository.GetAllAsync(x => !x.IsDelete);
        }
    }
}
